# Дизайн: матчинг «сервис → CVE» (детализация §6 ТЗ)
...
> Напоминание из ТЗ: результат — **«potentially vulnerable»**, не подтверждение.
...
**Справочные данные (локальные, из §5 ТЗ):**
...
Юнит-тесты матчинга — на фиксированных парах, сеть не трогаем (§12 ТЗ). Плюс
